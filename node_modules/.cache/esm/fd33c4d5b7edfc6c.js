let Subject;_b7e‍.x([["updateSubject",()=>updateSubject],["updateSubjectAPI",()=>updateSubjectAPI]]);_b7e‍.w("../../class/subject",[["Subject",["Subject"],function(v){Subject=v}]]);

       const updateSubject = async (id, update) => {
	try {
       ...
       const updateSubjectAPI = async (req, res) => {
