let Subject;_9bf‍.x([["updateMark",()=>updateMark],["updateMarkAPI",()=>updateMarkAPI]]);_9bf‍.w("../../class/subject",[["Subject",["Subject"],function(v){Subject=v}]]);

       const updateMark = async (id, update) => {
	try {
       ...
       const updateMarkAPI = async (req, res) => {
